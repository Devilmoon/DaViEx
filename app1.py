...
app.layout = html.Div([
    html.Div([
        ...
        style={'width': '33%', 'padding-right': '5px', 'display': 'inline-block'}),
    ...
    for i in dff.Region.unique():
        ...
        traces.append(go.Scatter(
            ...
            marker={
                'sizemode': 'area', 
                'opacity': 0.5,
                'size': df_by_region[df_by_region['Indicator Name'] == zaxis_column_name]['Value'].values,
                'sizemin': 10, 
...
@app.callback(
    ...
    [dash.dependencies.Input('crossfilter-indicator-scatter', 'hoverData'),
     dash.dependencies.Input('crossfilter-zaxis-column', 'value'), 
     dash.dependencies.Input('crossfilter-zaxis-type', 'value')])
def update_z_timeseries(hoverData, zaxis_column_name, axis_type):
    dff = df[df['Country Name'] == hoverData['points'][0]['customdata']]
